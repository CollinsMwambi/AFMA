...
<head>
	...
	<link rel="stylesheet" type="text/css" href="afma_authen.css">
</head>
<body>
...
<form action="ru.php" method="POST" class="border shadow p-3 rounded"
...
elseif(strpos($fullUrl,"login=wrong_user")==true){
  ...
  <button type="submit" name="adminruser" class="btn btn-primary">Create account</button>
