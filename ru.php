...
session_start();
    ...
    if (isset($_POST['adminruser'])) {
        ...
        if($datacheck){
            ...
            $message = "<a href ='http://localhost/AFMA/verifyuser.php?code=$code'>Register your Account by clicking this link</a>";
            ...
            header('location:verificationu.php');
